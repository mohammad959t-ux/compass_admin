...
const envSchema = z
  .object({
    ...
    UPLOADS_DIR: z.string().min(1, "UPLOADS_DIR cannot be empty").default("uploads"),
    UPLOADS_URL_PREFIX: z.string().min(1, "UPLOADS_URL_PREFIX cannot be empty").default("uploads"),
